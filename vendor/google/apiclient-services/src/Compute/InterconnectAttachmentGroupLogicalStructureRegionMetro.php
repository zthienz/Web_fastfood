...
class_alias(InterconnectAttachmentGroupLogicalStructureRegionMetro::class, 'Google_Service_Compute_InterconnectAttachmentGroupLogicalStructureRegionMetro');
