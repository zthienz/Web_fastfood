...
class InstanceGroup extends \Google\Collection
{
  ...
  /**
   * [Output Only] The creation timestamp for this instance group inRFC3339 text
   * format.
   *
   * @var string
   */
  ...
  public $network;
  /**
   * [Output Only] The URL of theregion where the instance group is located (for
   * regional resources).
   *
   * @var string
   */
  ...
  public $subnetwork;
  /**
   * [Output Only] The URL of thezone where the instance group is located (for
   * zonal resources).
   *
   * @var string
   */
