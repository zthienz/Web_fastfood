...
<head>
    ...
    <link rel="stylesheet" href="css/style.css"> <!-- Dùng file CSS chung đã có -->
</head>
<body class="login-page"> <!-- Quan trọng: thêm class login-page để kích hoạt nền kính mờ -->
        ...
        <div class="login-box">
            ...
            <form method="POST" autocomplete="off" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="username" id="username" value="<?= htmlspecialchars($username) ?>" placeholder="Nhập tên đăng nhập" required autofocus>
                </div>
